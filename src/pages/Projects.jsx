                ...
                <div className="snap-start shrink-0">
                    <StaggerItem>
                        ...
                        <h1 className="text-5xl md:text-7xl font-ultra-thin tracking-tighter mb-10 md:mb-12 text-slate-900 drop-shadow-sm">
                            Selected <strong className="font-heavy">Projects</strong>.
                        </h1>
                    </StaggerItem>
                </div>
                ...
                <div className="flex flex-col gap-12 md:gap-16 mb-24 max-w-5xl mx-auto text-center">
                    <StaggerItem>
                        <div className="bg-white/50 backdrop-blur-xl rounded-3xl p-12 border border-slate-200">
                            <h2 className="text-3xl font-heavy text-slate-900 mb-4">Coming Soon</h2>
                            <p className="text-slate-600">Detailed case studies of my technical and visual projects are being compiled.</p>
                        </div>
                    </StaggerItem>
                </div>
            </StaggerContainer>
